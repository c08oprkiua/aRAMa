...
void setup_os_exceptions() {
	OSSetExceptionCallback(OS_EXCEPTION_TYPE_DSI, &dsi_exception_cb);
	OSSetExceptionCallback(OS_EXCEPTION_TYPE_ISI, &isi_exception_cb);
	OSSetExceptionCallback(OS_EXCEPTION_TYPE_PROGRAM, &program_exception_cb);
}